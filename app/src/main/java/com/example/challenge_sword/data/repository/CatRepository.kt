...
interface CatRepository {
    ...
    fun getFavouriteCats(subId: String): Flow<List<FavouriteResponse>>
}
...
class CatRepositoryImpl @Inject constructor(private val api: CatService) : CatRepository {
    ...
    override fun getFavouriteCats(subId: String): Flow<List<FavouriteResponse>> {
        return flow {
            emit(api.getFavouriteCats(subId))
        }
    }
}
